...
int getValidInt(char requestMessage[],char errorMessage[], int lowLimit, int hiLimit)
{
    ...
    while(1)
    {
        ...
        {
            printf ("El numero no debe ser mayor a %d y menor a %d\n",hiLimit,lowLimit);
            continue;
...
float getValidFloat(char requestMessage[],char errorMessage[], float lowLimit, float hiLimit)
{
    ...
    while(1)
    {
        ...
        {
            printf ("El numero no debe ser mayor a %.2f y menor a %.2f\n",hiLimit,lowLimit);
            continue;
...
void getValidString(char requestMessage[],char errorMessage[], char input[], int lowLimit, int hiLimit)
{
    ...
    while(1)
    {
        ...
        letras = strlen(input);
        if(letras < lowLimit || letras > hiLimit)
        {
            printf ("El numero de caracteres no debe ser mayor a %d y menor a %d\n",hiLimit,lowLimit);
            continue;
        }
        cleanStdin();
        break;
